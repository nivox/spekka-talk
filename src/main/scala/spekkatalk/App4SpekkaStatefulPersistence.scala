...
case class App4Env(
  ...
  byDeploymentBuilder: StatefulFlowBuilder[EntranceCounterReading, App4SpekkaStatefulPersistence.CounterIncremented, App4SpekkaStatefulPersistence.GetCounter],
  byEntranceBuilder: StatefulFlowBuilder[EntranceCounterReading, App4SpekkaStatefulPersistence.CounterIncremented, App4SpekkaStatefulPersistence.GetCounter]
)
...
object App4SpekkaStatefulPersistence extends AppSkeleton[App4Env, NotUsed] {
  ...
  override def init()(implicit system: ActorSystem): App4Env = {
    ...
    val byDeploymentBuilder = registry.registerStatefulFlowSync("byDeployment", byDeploymentProps)
    val byEntranceBuilder = registry.registerStatefulFlowSync("byEntrance", byEntranceProps)
