...
case class App3Env(
  ...
  byDeploymentBuilder: StatefulFlowBuilder[EntranceCounterReading, App3SpekkaStateful.CounterIncremented, App3SpekkaStateful.GetCounter],
  byEntranceBuilder: StatefulFlowBuilder[EntranceCounterReading, App3SpekkaStateful.CounterIncremented, App3SpekkaStateful.GetCounter]
)
...
object App3SpekkaStateful extends AppSkeleton[App3Env, NotUsed] {
  ...
  override def init()(implicit system: ActorSystem): App3Env = {
    ...
    val backend = InMemoryStatefulFlowBackend.EventBased[State, CounterIncremented]()
